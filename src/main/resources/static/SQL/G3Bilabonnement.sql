...
(
    ...
    FOREIGN KEY (damage_report_id) REFERENCES damage_report (id) ON DELETE CASCADE ON UPDATE CASCADE
);
...
VALUES ('Søndergade 12', 'Aarhus', '8000'),
...
VALUES ('John', 'Doe', 'john.doe@example.com', '12345678', '010598-1234', '1001', '5678901234', 1),
...
VALUES ('Afleveringsforsikring', 119.00),
...
INSERT INTO car (image_url, vehicle_number, vin_number, car_model_id, equipment_level_id, power_source_id,
                 transmission_type_id, net_price, registration_tax, co2_emissions, car_status_id)
VALUES ('/images/pnvorrmtnq1wjf42i4rc.jpg', 'PNV123456', 'VIN1234567890', 1, 1, 1, 1, 15000.00, 2000.00, 120.00, 7),
       ('/images/cdfem4jk5dyrlmxqjgix.jpg', 'CDF123456', 'VIN2345678901', 2, 2, 1, 2, 18000.00, 2500.00, 140.00, 7),
       ('/images/slvpchujbacrfltszlns.jpg', 'SLV123456', 'VIN3456789012', 3, 3, 2, 2, 30000.00, 4000.00, 160.00, 7),
       ('/images/wn7o1exkl34h3xm82jxg.jpg', 'FIAT123456', 'VIN4567890123', 4, 1, 1, 1, 12000.00, 1800.00, 110.00, 2),
       ('/images/utxdwfbv2btg4ss5hopj.jpg', 'FIAT123457', 'VIN5678901234', 5, 2, 1, 2, 14000.00, 2100.00, 115.00, 2),
       ('/images/sbsmxmk5hy7tnzcuylt0.jpg', 'FIAT123458', 'VIN6789012345', 6, 3, 1, 2, 14500.00, 2200.00, 120.00, 2),
...
VALUES (2000.00, 'Limited', 1, 2500.00),
       (3000.00, 'Limited', 2, 3500.00),
       (4000.00, 'Unlimited', 3, 4500.00);

INSERT INTO subscription_SubscriptionAddon (subscription_id, addon_id)
VALUES (1, 1),
       (1, 2),
       (2, 3),
       (3, 1),
...
INSERT INTO rental_agreement (car_id, subscription_id, renter_id, start_date, end_date, pickup_location_id,
                              return_location_id)
VALUES (1, 1, 1, '2021-01-01', '2024-06-01', 1, 2),
       (2, 2, 2, '2022-02-01', '2024-07-01', 2, 3),
       (3, 3, 3, '2023-12-01', '2024-08-01', 3, 1),
       (4, 1, 4, '2024-01-01', '2025-06-01', 1, 2),
       (5, 2, 5, '2023-02-01', '2025-07-01', 2, 3),
       (6, 3, 6, '2024-12-01', '2025-08-01', 3, 1);

-- Damage reports with specifications
...
VALUES
-- Karosseriskader
('Bule på højre dør', 1200.00, 1),
('-', 0, 2),
('Ridse på kølerhjelm', 1000.00, 3),

-- Glas- og lygteskader
('Knust forrude', 5000.00, 1),
('Defekt blinklys', 250.00, 2),
('-', 0, 3),

-- Hjul- og dækskader
('Punkteret dæk', 1500.00, 1),
('Skade på fælg', 1000.00, 2),
('-', 0, 3),

-- Interiørskader
('-', 0, 1),
('-', 0, 2),
('Reparation af dørhåndtag', 500.00, 3),

-- Mekaniske og tekniske skader
('-', 0, 1),
('Defekt bremse', 3000.00, 2),
('-', 0, 3),

-- Andet
('Reparation af kofanger', 1200.00, 1),
('-', 0, 2),
('-', 0, 3);

-- Final settlements
INSERT INTO final_settlement (rental_agreement_id, damage_report_id, total_km_driven, total_price)
VALUES (1, 1, 12000, 25000.00),
       (2, 2, 15000, 30000.00),
       (3, 3, 18000, 35000.00);

-- Purchase agreements
INSERT INTO purchase_agreement (car_id, final_settlement_id, pickup_location, final_price)
VALUES (1, 1, 'København', 150000.00),
       (2, 2, 'Aarhus', 180000.00),
       (3, 3, 'Odense', 200000.00);